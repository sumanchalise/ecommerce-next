          ...
          <div className="text-gray-250 flex w-full flex-col items-center justify-start gap-5 lg:justify-center">
            <div className="flex flex-col items-start  gap-5 lg:flex-row  lg:items-center ">
              ...
              <input
                ...
                placeholder="Email"
                required
                className=" w-96 rounded-md border-2 border-gray-300 px-3 py-2 leading-tight text-gray-700 focus:outline-none  lg:w-[490px]"
              />
            </div>
            <div className="flex flex-col items-start  gap-5 lg:flex-row lg:items-center ">
              <label className="w-20 text-lg">Password:</label>
              <input
                type="password"
